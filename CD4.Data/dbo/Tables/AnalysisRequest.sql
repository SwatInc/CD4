...
,   [ClinicalDetailId] INT NOT NULL DEFAULT 0, -- Zero Will be NA on scientist table
    ...
    CONSTRAINT [FK_AnalysisRequest_ClinicalDetail] FOREIGN KEY ([ClinicalDetailId]) REFERENCES [dbo].[ClinicalDetail]([Id]))