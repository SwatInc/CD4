...
namespace CD4.DataLibrary.DataAccess
{
    public interface IResultDataAccess
    {
        ...
        Task<UpdatedResultAndStatusModel> InterfaceUpdateResultByTestIdAndCinAsync(int testId, string cin, string result, string batchId, string referenceCode, int testStatus, int userId);
