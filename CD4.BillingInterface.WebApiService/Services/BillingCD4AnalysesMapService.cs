...
{
    public class BillingCD4AnalysesMapService : IBillingCD4AnalysesMapService
    {
        private readonly IStaticDataDataAccess _staticDataDataAccess;
        private readonly ILogger _logger;

        public BillingCD4AnalysesMapService(IStaticDataDataAccess staticDataDataAccess, ILogger<BillingCD4AnalysesMapService> logger)
        {
